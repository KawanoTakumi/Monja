...
public class Item_Power : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        //ƒ^[ƒ“Œo‰ßŒn‚ÌƒAƒCƒeƒ€‚ğæ“¾‚µ‚½‚Æ‚«ƒAƒCƒeƒ€Œø‰Ê‚ÌƒƒO‚ğ•\¦
        ...
        if (bowlingball_flag == true)
        {
            if(adapt_bowlingball == true && first_turn == true)
            {
                ...
                Log_list.LogList.Add("@ƒ{ƒEƒŠƒ“ƒO‚Ì‹Ê‚ÌŒø‰Ê‚Å•¨—UŒ‚—Í‚ª‚Q‚O‘‰Á‚µA•¨—–hŒä—Í‚ª‚Q‚OŒ¸­‚µ‚½\n");//ƒƒOƒŠƒXƒg‚É’Ç‰Á
        ...
        if(cd_flag == true)
        {
            if(adapt_cd == true && first_turn == true)
            {
                ...
                Log_list.LogList.Add("@CD‚ÌŒø‰Ê‚Å•¨—UŒ‚—Í‚ª" + cd_num + "‘‰Á‚µ‚½@\n");
                adapt_cd = false;
            }
        }
        ...
        if(kesigomu_flag == true)
        {
            if(adapt_kesigomu == true && first_turn == true)
            {
                ...
                Log_list.LogList.Add("@Á‚µƒSƒ€‚ÌŒø‰Ê‚Å•¨—UŒ‚—Í‚ª‚Q‚O‘‰Á‚µA–‚–@UŒ‚—Í‚ª"+kesigomu_num+"@\n");
        ...
        if(TV_flag == true)
        {
            ...
            {
                Debug.Log("TV");
                playercontroller.Magic_damage += (playercontroller.Magic_damage / 5) * 3;//–‚–@UŒ‚—Í‚T‚É‚Â‚«–‚–@UŒ‚—Í‚ğ‚Rã¸
                adapt_TV = false;
            }
        }
        ...
        if(Drill_flag == true)
        {
            if(adapt_Drill == true && first_turn)
            {
                ...
                playercontroller.Attack_damage += enemy_Controller.Enemy_deffence / 2;
                adapt_Drill = false;
            }
        }
