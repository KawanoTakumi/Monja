        ...
        if (turn_compare < Enemy_controller.turn)
        {
            ...
            if (Safetycone_flag == true)
            {
                if (adapt_SafetyCorn == true && first_turn == true)
                {
                    ...
                    else if (safetycorn_random == 6)
                    {
                        ...
                        Log_list.LogList.Add("@OŠpƒR[ƒ“‚Å•¨U‚Æ•¨–h‚S‚O‘‰Á@\n");
                        adapt_SafetyCorn = false;
                    }
                }
            }
            if (USB_flag == true)
            {
                if (adapt_USB == true && first_turn == true)
                {
                    ...
                    Log_list.LogList.Add("@USB‚Å–‚U‚Q‚O‘‰ÁA–‚–h‚P‚OŒ¸­@\n");
                    adapt_USB = false;
                }
            }
            if (Smartphone_flag == true)
            {
                if (adapt_SmartPhone == true && first_turn == true)
                {
                    ...
                    Log_list.LogList.Add("@ƒXƒ}[ƒgƒtƒHƒ“‚Å–‚–h" + SmartPhone_num + "‘‰Á@\n");
            ...
            if (ItypeMagnet_flag == true)
            {
                if (adapt_Itype_M == true && first_turn == true)
                {
                    ...
                    Log_list.LogList.Add("@IšŒ^ƒ}ƒOƒlƒbƒg‚Å–‚–h‚Q‚O‘‰Á@\n");
                    adapt_Itype_M = false;
                }
            }
            if (Mike_flag == true)
            {
                if (adapt_Mike == true && first_turn == true)
                {
                    Debug.Log("Mike");
                    playercontroller.Magic_damage += 30;//–‚–@UŒ‚—Í‚ğ‚R‚O‘‰Á‚³‚¹‚é
                    Log_list.LogList.Add("@ƒ}ƒCƒN‚Å–‚U‚R‚O‘‰Á@\n");
                    adapt_Mike = false;
                }
            }
            if (Megaphone_flag == true)
            {
                if (adapt_Megaphone == true && first_turn == true)
                {
                    ...
                    Log_list.LogList.Add("@ƒƒKƒzƒ“‚Å•¨–h‚Q‚O‘‰Á@\n");
            ...
            if (HandMill_flag == true)
            {
                ...
                if (adapt_HandMill == true && Coffee_flag == true && first_turn == true)
                {
                    ...
                    Log_list.LogList.Add("@ƒR[ƒq[‚Æƒnƒ“ƒhƒ~ƒ‹‚Å–‚U‚U‚O‘‰Á@\n");
                ...
                else if (adapt_HandMill == true && first_turn == true)
                {
                    ...
                    Log_list.LogList.Add("@ƒnƒ“ƒhƒ~ƒ‹‚Å–‚U‚R‚O‘‰Á@\n");
                    adapt_HandMill = false;
                }
            }
            if (Poteto_flag == true)
            {
                ...
                if (adapt_Poteto == true && Hamberger_flag == true && first_turn == true)
                {
                    ...
                    Log_list.LogList.Add("@@ƒ|ƒeƒg‚Æƒnƒ“ƒo[ƒK[‚Å•¨U‚U‚O‘‰Á@\n");
                    adapt_Poteto = false;
                }
                else if (adapt_Poteto == true && first_turn == true)
                {
                    ...
                    Log_list.LogList.Add("@ƒ|ƒeƒg‚Å•¨U‚R‚OŒ¸­@\n");
                    adapt_Poteto = false;
                }
            }
            if (Scop_flag == true)
            ...
            if (Baseball_glove_flag == true)
            {
                ...
                if (adapt_Baseball_glove == true && baseball_ball_flag == true && first_turn == true)
                {
                    ...
                    Log_list.LogList.Add("@–ì‹…ƒ{[ƒ‹‚Æ–ì‹…ƒOƒ[ƒu‚Å•¨U‚Q‚T‘‰ÁA•¨–h‚P‚T‘‰Á@\n");
                ...
                else if (adapt_Baseball_glove == true && first_turn == true)
                {
                    ...
                    playercontroller.Attack_damage += 25;//•¨—UŒ‚—Í‚ğ‚Q‚T‘‰Á
                    Log_list.LogList.Add("@–ì‹…ƒOƒ[ƒu‚Å•¨U‚Q‚T‘‰Á@\n");
                    adapt_Baseball_glove = false;
                }
            }
            if (Boxing_glove_flag == true)
            {
                ...
                if (adapt_Boxing_glove == true && first_turn == true)
                {
                    ...
                    Log_list.LogList.Add("@ƒ{ƒNƒVƒ“ƒOƒOƒ[ƒu‚ÅƒUƒ“ƒQƒL‚ğ‰Ÿ‚·‚Æ•¨U‚ª‚R‘‰Á@\n");
                }
            }
            if (Juice_flag == true)
            {
                if (adapt_Juice == true && first_turn == true)
                {
                    ...
                    Log_list.LogList.Add("@ƒWƒ…[ƒX‚Å‘Ì—Í‚ğ‚Q‚O‰ñ•œ@\n");
                    adapt_Juice = false;
                }
            }
            ...
            if (Hamberger_flag == true)
            {
                ...
                if (adapt_Hamberger == true && Poteto_flag == true && first_turn == true)
                {
                    Debug.Log("Hamberger");
                    playercontroller.Attack_damage += 40;//•¨—UŒ‚—Í‚ğ‚S‚O‘‰Á‚³‚¹‚é
                    Log_list.LogList.Add("@ƒnƒ“ƒo[ƒK[‚Æƒ|ƒeƒg‚Å•¨U‚S‚O‘‰Á@\n");
                ...
                else if (adapt_Hamberger == true && first_turn == true)
                {
                    ...
                    Log_list.LogList.Add("@ƒnƒ“ƒo[ƒK[‚Å•¨U‚Q‚O‘‰Á@\n");
                    adapt_Hamberger = false;
                }
            }
            if (Pencil_flag == true)
            {
                ...
                if (adapt_Pencil == true && first_turn == true)
                {
                    ...
                    Log_list.LogList.Add("@‰”•M‚Å•¨U‚T‚O‘‰Á@\n");
                    adapt_Pencil = false;
                }
            }
            if (Mayonnaise_flag == true)
            {
                if (adapt_Mayonnaise == true && first_turn == true)
                {
                    ...
                    Log_list.LogList.Add("@ƒ}ƒˆƒl[ƒY‚Å–‚U‚T‚O‘‰Á@\n");
            ...
            if (radio_flag == true)
            {
                if (PlayerController.HP > 11)
                {
                    ...
                    log_text.text = "ƒ‰ƒWƒI‚Å‘Ì—Í‚ª‚TŒ¸­";
                    Log_list.LogList.Add("@ƒ‰ƒWƒI‚Å‘Ì—Í‚ª‚TŒ¸­\n");//ƒƒOƒŠƒXƒg‚É’Ç‰Á
                }
                else
                {
            ...
            if (hourglass_flag == true)
            {
                if (PlayerController.HP >11)
                {
                    ...
                    Log_list.LogList.Add("@»Œv‚Å‘Ì—Í‚ª‚TŒ¸­\n");//ƒƒOƒŠƒXƒg‚É’Ç‰Á
                }
                else
                {
            ...
            {
                Debug.Log("Scissors");
                Log_list.LogList.Add("@ƒnƒTƒ~‚Å•¨–h‚QŒ¸­\n");
            ...
            if (Headphone_flag)
            {
                ...
                else
                {
                    ...
                    Log_list.LogList.Add("@ƒwƒbƒhƒzƒ“‚Å‘Ì—Í‚ğ‚P‚O‰ñ•œ‚µA•¨U‚Æ•¨–h‚RŒ¸­\n");
                }
            }
            if (MagnifyingSpeculum_flag == true)
            {
                Debug.Log("Magnifying");
                Log_list.LogList.Add("@’Šá‹¾‚Å•¨–h‚Æ–‚–h‚R‘‰Á\n");
            ...
            if (Sylinge_flag == true)
            {
                ...
                if (sylinge_random == 6)
                {
                    Log_list.LogList.Add("@’ËŠí‚Å‘Ì—Í‚ª‚R‚O‰ñ•œ\n");
                    PlayerController.HP += 30;//‘Ì—Í‚ğ‚R‚O‰ñ•œ‚³‚¹‚é
                }
                else
                {
                    Log_list.LogList.Add("@’ËŠí‚Å‘Ì—Í‚ª‚T‰ñ•œ\n");
            ...
            if (Mayonnaise_flag == true)
            {
                ...
                if (Pencil_Down_cnt <= 10)
                {
                    Log_list.LogList.Add("@ƒ}ƒˆƒl[ƒY‚Å–‚U‚TŒ¸­\n");
            ...
            if (Dragon_Scale_flag == true)
            {
                ...
                Log_list.LogList.Add("@ƒhƒ‰ƒSƒ“‚Ì—Ø‚Å‘SƒXƒe[ƒ^ƒX‚P‚Oã¸\n");
